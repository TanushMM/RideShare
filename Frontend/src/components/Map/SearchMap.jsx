...
const SearchRidePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      alert(
        "Please fill all the fields and ensure the distance and travel time are calculated."
      )
      return
    }
    ...
    try {
      ...
      // Don't use await - the backend works frine but this axios still returns AxiosError
      axios.post(
        `http://${import.meta.env.VITE_SERVER_IP}:8000/ride/search-ride/post`,
        data,
        config
      )
    ...
    return (
      ...
      >
        <Typography variant="h6">
          There is an existing ride search. Please cancel it to continue.
        </Typography>
        <Button
          variant="contained"
          color="primary"
  ...
  return (
    <div style={{ position: "relative", height: "100vh", width: "100vw" }}>
      ...
      >
        <Typography
          variant="h6"
          sx={{ fontSize: 30, fontFamily: "Poppins", fontWeight: 500 }}
          gutterBottom
        >
          SEEK A RIDE
        </Typography>
