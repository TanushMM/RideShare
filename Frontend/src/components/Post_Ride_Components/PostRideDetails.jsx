...
const PostRideDetails = () => {
    ...
    const fetchMatches = async () => {
      ...
      try {
        const response = await axios.get(
          ...
          }:8000/ride/match-ride/poster-match`,
          config
        )
  ...
  const handleGoBack = () => {
    ...
    if (driverDetails) {
      fetchDriverRoute(
        driverDetails.from.coordinates,
        driverDetails.to.coordinates
      )
    }
  }
    ...
    >
        ...
        >
          {selectedRider ? (
            <>
              ...
              <Typography
                variant="body1"
                sx={{ fontSize: "1.2rem", color: "gray", mb: 1 }}
              >
              ...
              <Typography
                variant="body1"
                sx={{ fontSize: "1.2rem", color: "black", mb: 1 }}
              >
      ...
      <Box sx={{ flexGrow: 1 }}>
        <GoogleMap
          ...
          center={
            driverDetails ? driverDetails.from.coordinates : { lat: 0, lng: 0 }
          }
          zoom={10}
        >
          {directionsResponse && (
